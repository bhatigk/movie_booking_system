...
class ShowtimesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create showtime" do
    assert_difference("Showtime.count") do
      post showtimes_url, params: { showtime: { movie_id: @showtime.movie_id, timing: @showtime.timing } }
    end
  ...
  test "should update showtime" do
    patch showtime_url(@showtime), params: { showtime: { movie_id: @showtime.movie_id, timing: @showtime.timing } }
