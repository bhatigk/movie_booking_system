...
class SeatsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create seat" do
    assert_difference("Seat.count") do
      post seats_url, params: { seat: { booked: @seat.booked, category: @seat.category, name: @seat.name, row: @seat.row, showtime_id: @seat.showtime_id } }
    end
  ...
  test "should update seat" do
    patch seat_url(@seat), params: { seat: { booked: @seat.booked, category: @seat.category, name: @seat.name, row: @seat.row, showtime_id: @seat.showtime_id } }
